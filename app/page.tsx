...
const testimonials = [
  ...
  },
  {
    ...
    text: "Хороший педагог. Объясняет все понятно и доходчиво. Занимаемся несколько недель, чувствую, как сильно импрувнулась за это время. Всем советую!",
  },
  {
    name: "LIKA",
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <CertificateCard
            ...
            subtitle="Система в нейропедагогике"
